...
// FormViewDoc.cpp: CFormViewDoc 클래스의 구현
//
...
CFormViewDoc::CFormViewDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CFormViewDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CFormViewDoc::InitializeSearchContent()
{
...
void CFormViewDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
